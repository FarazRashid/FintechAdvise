 ...
 * Use the [OnboardingScreen1Fragment.newInstance] factory method to
...
class OnboardingScreen1Fragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment OnboardingScreen1Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OnboardingScreen1Fragment().apply {
