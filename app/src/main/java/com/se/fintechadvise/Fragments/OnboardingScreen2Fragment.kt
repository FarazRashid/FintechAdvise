 ...
 * Use the [OnboardingScreen2Fragment.newInstance] factory method to
...
class OnboardingScreen2Fragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment OnboardingScreen2Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            OnboardingScreen2Fragment().apply {
